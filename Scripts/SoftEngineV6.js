...
(function (SoftEngine) {
    ...
    var Mesh = (function () {
        function Mesh(name, verticesCount, facesCount, faceColor, wireColor) {
            this.name = name;
            ...
            this.Collider = null;
            this.NetForce = new BABYLON.Vector3(0, 0, 0);
        }
        return Mesh;
    })();
    ...
    var Device = (function () {
        ...
        Device.prototype.render = function (camera, meshes) {
            ...
            for (var index = 0; index < meshes.length; index++) {
                ...
                var rotationMatrix = BABYLON.Matrix.RotationYawPitchRoll(cMesh.Rotation.y, cMesh.Rotation.x, cMesh.Rotation.z);
                var worldMatrix = rotationMatrix.multiply(BABYLON.Matrix.Translation(cMesh.Position.x, cMesh.Position.y, cMesh.Position.z));
                ...
                for (var indexFaces = 0; indexFaces < cMesh.Faces.length; indexFaces++) {
                    ...
                    var normalVector = BABYLON.Vector3.TransformCoordinates(new BABYLON.Vector3(normalX, normalY, normalZ), rotationMatrix);
                        ...
                        if (normalDotCamera <= 0 && faceCamSpace.z > 0) {
                            ...
                            if ((pixelA.x >= -edgePadding && pixelA.x <= this.workingWidth + edgePadding && pixelA.y >= -edgePadding && pixelA.y <= this.workingHeight + edgePadding) ||
                                ...
                                if (drawFog === true) {
                                    ...
                                    let distRatio = camDist / (8 * (renderDistance + 0.5));
                                ...
                                if (showWires) {
                                    this.drawLine(pixelA, pixelB, cMesh.WireColor, 0);
                                    this.drawLine(pixelB, pixelC, cMesh.WireColor, 0);
			...
			this.drawPoint(new BABYLON.Vector2(this.workingWidth / 2, this.workingHeight / 2), white);
        };
